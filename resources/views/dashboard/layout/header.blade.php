          ...
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              <span class="app-brand-logo demo">
                <img src="{{ url('homepage/img/logo-pwk.png') }}" height="25px" alt="" srcset="">
              </span>
              {{-- <span class="app-brand-text demo menu-text fw-bolder ms-2">Dinas Kesehatan</span> --}}
              <span class="fw-bolder text-black ms-4">Dinas Kesehatan</span>
            </a>
